...
Graphout.prototype.setupOutputs = function() {
    for (var i in this.options.outputs) {
        try {
            ...
            this.log.error("cannot load output,", {error: e.message, output: i, module: output_module});
            continue;
        }

        this.log.info("loaded output", {output: i, module: output_module});
    }
};
